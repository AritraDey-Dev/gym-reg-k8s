...
kubectl apply -f backend/backend-main-service.yaml --context kind-"$CLUSTER_NAME"
kubectl apply -f backend/backend-stream-deployment.yaml --context kind-"$CLUSTER_NAME"
kubectl apply -f backend/backend-stream-service.yaml --context kind-"$CLUSTER_NAME"
...
kubectl apply -f frontend/service.yaml --context kind-"$CLUSTER_NAME"
kubectl apply -f admin-panel/deployment.yaml --context kind-"$CLUSTER_NAME"
kubectl apply -f admin-panel/service.yaml --context kind-"$CLUSTER_NAME"
